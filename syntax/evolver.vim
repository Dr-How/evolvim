...
syn region sePreamble		start="\%^" end="^\ze\s*vertices" fold contains=ALLBUT,@seElementAttr,@seElementsList,seProgram
...
syn region seVerticesList	end="^\ze\s*\a" matchgroup=seElementsBegin start="^\s*vertices\s*$" fold contains=seVertexAttr
syn region seEdgesList		end="^\ze\s*\a" matchgroup=seElementsBegin start="^\s*edges\s*$" fold contains=seEdgeAttr
syn region seFacesList		end="^\ze\s*\a" matchgroup=seElementsBegin start="^\s*faces\s*$" fold contains=seFaceAttr
syn region seFacesList		end="^\ze\s*\a" matchgroup=seElementsBegin start="^\s*facets\s*$" fold contains=seFaceAttr
syn region seBodiesList		end="^\ze\s*\a" matchgroup=seElementsBegin start="^\s*bodies\s*$" fold contains=seBodyAttr
